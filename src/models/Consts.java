...
public class Consts {
    ...
    public static final String IWillGoToStore = "I_WILL_GO_TO_STORE";

    public static final String GoodMorning = "GOOD_MORNING";
    public static final String IGoToTheBedPrefix = "I_GO_TO_THE_BED.NEED_NEXT_DAY:";
    public static final String GoodNight = "GOOD_NIGHT";
}
